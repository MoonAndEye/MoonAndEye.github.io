...
description: "A real-world Figma Make trap: I gave the agent a demo link, so it treated the demo as the spec. The real fix is defining behavior first—your launch state machine."
---
